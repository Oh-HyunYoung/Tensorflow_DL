...
for i in range(1,13):
    ...
    cb_checkpointer = ModelCheckpoint(filepath = './working/'+leadFolder+'/lr_ResNet50_32.hdf5', 
                                      monitor = 'val_loss', 
                                      save_best_only = True, 
                                      mode = 'auto')
    ...
    model.load_weights("./working/"+leadFolder+"/lr_ResNet50_32.hdf5")
